// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "BM - Place order Backend + Email - Affirm (Temporal)"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { checkOrderOnMyAccount, extractUserFromEmail, fillCheckout, loginAdmin, selectPayWithAffirm } from '../helpers/bm-common-steps';
...
test.describe('BM - Place order Backend + Email - Affirm (Temporal)', () => {
