// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "Elka - Place order CAD"
...
test.describe('Elka - Place order CAD', () => {
  ...
  test('01 - New User - Place Order CAD', async ({ page }) => {
    await page.goto(`/`);
    await page.waitForLoadState('load');

    // ↓ 12 - Checkout page CAD
    ...
    await page.locator(`div > div:nth-child(3) > a > span.fusion-button-text.fusion-button-text-right`).or(page.locator(`.fusion-button-text.fusion-button-text-right`)).filter({ visible: true }).first().click({ force: true });
