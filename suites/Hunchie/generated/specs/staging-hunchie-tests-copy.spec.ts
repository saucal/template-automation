// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "STAGING - Hunchie - Tests (Copy)"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { blockImageSizes } from '../helpers/common-steps-for-all-projects';
import { _01HomePage, _02ShopPage, _03SimpleProductPage, _07CartPage } from '../helpers/template-woocommerce-tests';
...
test.describe('STAGING - Hunchie - Tests (Copy)', () => {
