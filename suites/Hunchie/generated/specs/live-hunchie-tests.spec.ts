// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "LIVE - Hunchie - Tests"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { blockImageSizes } from '../helpers/common-steps-for-all-projects';
import { _01HomePage, _02ShopPage, _03SimpleProductPage, _07CartPage, _08CheckoutPage } from '../helpers/template-woocommerce-tests';
...
test.describe('LIVE - Hunchie - Tests', () => {
