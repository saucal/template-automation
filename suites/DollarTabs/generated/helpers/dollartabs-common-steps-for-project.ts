// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "DollarTabs - Common steps for Project"
...
// GI: "Admin Login" (69a82b73b9fc488447ef7c9b)
...
// GI: "Check Order Details - Thank you page and My Account" (69a82b73b9fc488447ef7c9c)
...
// GI: "Check order Details in backend" (69a82b73b9fc488447ef7c9e)
...
// GI: "Check Total" (69a82b73b9fc488447ef7c9d)
...
// GI: "Extract user from email" (69a82b73b9fc488447ef7c9f)
...
// GI: "Fill CC" (69a82b73b9fc488447ef7ca0)
...
// GI: "Fill Checkout" (69a82b73b9fc488447ef7ca1)
...
// GI: "First letter Capitalized" (69a82b73b9fc488447ef7ca2)
...
// GI: "Go to My Account & Check Order Details" (69a82b73b9fc488447ef7ca3)
...
// GI: "Login" (69a82b73b9fc488447ef7ca4)
export async function login(page: Page, vars: Record<string, string> = {}): Promise<void> {
  if (await _giEval(page, (vars: any) => { vars = new Proxy(vars, { get: (o, k) => (k in o ? o[k] : '') }); const elem = document.querySelector('#customer_login')
...
// GI: "Place Order - New User - Backend" (69a82b73b9fc488447ef7ca5)
...
// GI: "Place Order - New User - Email" (69a82b73b9fc488447ef7ca6)
...
// GI: "Place Order - New User - Refund" (69a82b73b9fc488447ef7ca7)
...
// GI: "Place Order - New User - Refund Email" (69a82b73b9fc488447ef7ca8)
...
// GI: "Registration" (69a82b73b9fc488447ef7ca9)
export async function registration(page: Page, vars: Record<string, string> = {}): Promise<void> {
  ...
  await expect(page.locator(`.woocommerce`)).not.toHaveCount(0);
  await expect(page.locator(`.woocommerce-info`).first()).toContainText(`Your account with DollarTabs.Com is using a temporary password. We emailed you a link to change your password.`);
}

// GI: "Thank you page" (69a82b73b9fc488447ef7caa)
...
// GI: "Under 21 Age" (69a82b73b9fc488447ef7cab)
export async function under21Age(page: Page, vars: Record<string, string> = {}): Promise<void> {
  if (await _giEval(page, (vars: any) => { vars = new Proxy(vars, { get: (o, k) => (k in o ? o[k] : '') }); const elem = document.querySelector('.age-gate__form')

return !!elem }, vars)) {
    await expect(page.locator(`.age-gate__form`)).not.toHaveCount(0);
  }
  if (await _giEval(page, (vars: any) => { vars = new Proxy(vars, { get: (o, k) => (k in o ? o[k] : '') }); const elem = document.querySelector('.age-gate__form')

return !!elem }, vars)) {
    await expect(page.locator(`.age-gate__challenge`).first()).toContainText(`Are you over 21 years of age?`);
  }
  if (await _giEval(page, (vars: any) => { vars = new Proxy(vars, { get: (o, k) => (k in o ? o[k] : '') }); const elem = document.querySelector('.age-gate__form')

return !!elem }, vars)) {
    await page.locator(`xpath=//button[contains(text(), "Yes")]`).or(page.locator(`button.age-gate__submit--yes`)).filter({ visible: true }).first().click({ force: true });
  }
}
