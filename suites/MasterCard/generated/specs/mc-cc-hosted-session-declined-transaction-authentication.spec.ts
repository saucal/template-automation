// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "MC - CC - Hosted Session - Declined Transaction/Authentication"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { addDownloadProductToCart, addPhysicalProductToCart, addVirtualProductToCart, checkTransaction, checkTranscationIsPresentOnOrderBackend, fillCheckout, getWooOrderDetails, placeOrder, useMASTERFrictionlessACSNo, useMASTERFrictionlessACSYes, useVISAFrictionless, verifyTransactionOnLogs } from '../helpers/mc-common-steps-for-tests';
...
test.describe('MC - CC - Hosted Session - Declined Transaction/Authentication', () => {
  ...
  test('MC-014 - Declined transaction - Admin', async ({ page }) => {
    await page.goto(`/`);
    await page.waitForLoadState('load');
