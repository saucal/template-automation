// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "MC - CC - Subscription + Upgrade"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { addPhysicalSubscriptionProductToCart, checkTranscationIsPresentOnOrderBackend, fillCheckout, getWooOrderDetails, getWooSubscriptionDetails, login, loginAdmin, placeOrder, renewalOrder, subscriptionUpgradeManualRenewCancelChangePaymentMEthod, useVISAChallenge, verifyTransactionOnLogs } from '../helpers/mc-common-steps-for-tests';
...
test.describe('MC - CC - Subscription + Upgrade', () => {
  ...
  test('MC-064 - Upgrade Subscription - Admin', async ({ page }) => {
    await page.goto(`/`);
    await page.waitForLoadState('load');
  ...
  test('MC-064 - Upgrade Subscription - Renewal of Upgrade', async ({ page }) => {
    await page.goto(`/`);
    await page.waitForLoadState('load');
