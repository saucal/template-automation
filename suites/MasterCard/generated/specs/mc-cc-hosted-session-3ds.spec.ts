// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "MC - CC - Hosted Session - 3DS"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { addDownloadProductToCart, addPhysicalProductToCart, addVirtualProductToCart, checkTransaction, checkTranscationIsPresentOnOrderBackend, fillCheckout, getWooOrderDetails, login, placeOrder, useVISAChallenge, useVISAFrictionless, useVISAFrictionlessAttempted, verifyTransactionOnLogs } from '../helpers/mc-common-steps-for-tests';
...
test.describe('MC - CC - Hosted Session - 3DS', () => {
