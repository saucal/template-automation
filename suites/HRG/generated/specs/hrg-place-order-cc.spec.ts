// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "HRG - Place Order - CC"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { blockUI, placeOrderElement } from '../helpers/common-steps-for-all-projects';
import { checkOrderDetailsThankYouPageAndMyAccount, checkTotal, closePopup, extractUserFromEmail, fillCC, fillCheckout, goToMyAccountCheckOrderDetails, login, placeOrderNewUserBackend, placeOrderNewUserEmail, placeOrderNewUserRefund, placeOrderNewUserRefundEmail, thankYouPage } from '../helpers/hrg-common-steps';
...
test.describe('HRG - Place Order - CC', () => {
