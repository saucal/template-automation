// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "Simply7oh - Place Order - New User"
// Review all TODOs before running.
import dotenv from 'dotenv';
dotenv.config();
import { test, expect } from '@playwright/test';
import { blockUI, placeOrderElement } from '../helpers/common-steps-for-all-projects';
import { checkOrderDetailsThankYouPageAndMyAccount, fillCC, fillCheckout, goToMyAccountCheckOrderDetails, login, placeOrderNewUserBackend, placeOrderNewUserEmail, placeOrderNewUserRefund, placeOrderNewUserRefundEmail, thankYouPage, under18Age } from '../helpers/simply7oh-common-steps-for-project';
...
test.describe('Simply7oh - Place Order - New User', () => {
