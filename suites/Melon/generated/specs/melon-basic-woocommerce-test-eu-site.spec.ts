// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "Melon - Basic WooCommerce Test - EU Site"
...
test.describe('Melon - Basic WooCommerce Test - EU Site', () => {
...
return url === `${vars.url}` }, vars)).toBeTruthy();
  ...
  test('02 - Accessories Page', async ({ page }) => {
    ...
    await page.waitForLoadState('load');
    await page.locator(`li.mega-menu-item.mega-align-bottom-left:nth-of-type(4) > a[href="#"].mega-menu-link`).filter({ visible: true }).first().click({ force: true });
    await page.waitForTimeout(9000);
    await page.locator(`li.menu-item > a[href*="/product-category/accessories/"]`).filter({ visible: true }).first().click({ force: true });
    await page.waitForLoadState('load');
  });
...
return test != "slider" })()) {
  ...
  test('10 - Place order - No Upsell', async ({ page }) => {
    await page.goto(`/eu`);
    await page.waitForLoadState('load');

    vars.test = ``;
    // ↓ 01 - Place order - No Upsell
    // ↓ 05 - Checkout page
    // ↓ 04 - Cart Page
    // ↓ 03 - Product page
    // ↓ 02 - Bike Menu
...
${vars.stateComplete ?? ''}
${vars.countryComplete ?? ''}`);
    // ↑ end 01 - Place order - No Upsell
  });

  test('10 - Place order - No Upsell - Email', async ({ page }) => {
    await page.goto(`/eu`);
    await page.waitForLoadState('load');
