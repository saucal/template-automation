// @ts-nocheck
// Auto-generated from Ghost Inspector suite: "Melon - Upsell Accepted - Place Order - UK Site"
...
test.describe('Melon - Upsell Accepted - Place Order - UK Site', () => {
  ...
  test('01 - Place order - Upsell Accepted', async ({ page }) => {
    await page.goto(`/`);
