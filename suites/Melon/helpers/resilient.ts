// Resilient action/assertion wrapper (rule 23, docs/locator-fallback-strategy.md).
//
...
// Per-tier actionability budget. Matches playwright.config actionTimeout (15s) so
// routing a raw .click() through the wrapper doesn't shorten the slack it had —
// the storefront's re-showing popup + slowMo can push a legit click past 8s.
