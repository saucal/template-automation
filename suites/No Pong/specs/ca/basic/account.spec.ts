...
test.describe('CA Account flows', { tag: ['@plugin:woocommerce'] }, () => {
  test('NP-CA-ACC-01 — register, My Account links, login', async ({ shopperPage }) => {
  ...
  test('NP-CA-ACC-02 — forgot password', async ({ shopperPage }) => {
