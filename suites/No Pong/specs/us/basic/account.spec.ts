...
test.describe('US Account flows', { tag: ['@plugin:woocommerce'] }, () => {
  test('NP-US-ACC-01 — register, My Account links, login', async ({ shopperPage }) => {
  ...
  test('NP-US-ACC-02 — forgot password', async ({ shopperPage }) => {
